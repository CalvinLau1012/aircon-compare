...
本目錄分開保存規範、決策、歷史證據與目前狀態。文件核對日期：2026-09-22；v1.2.9 候選再加入 D1-B／D2-A／D4-A／D7-A／D8-A，全部本機 E2，未 commit／push／deploy。
...
| [DECISIONS.md](DECISIONS.md) | D1–D17 已記錄決策及原因（D17 為 2026-09-22 D1-B..D9-A） | 保留決策日期；實施狀態須配合證據核對 |
...
python scripts/build_pages_artifact.py --check-only  # D2-A Pages artifact manifest 驗證
