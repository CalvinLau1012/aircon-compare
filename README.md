# ❄️ 香港空調對比報告（網頁版） ![version](https://img.shields.io/badge/version-v1.2.6-2ea44f)
...
> 📌 **現況（2026-08-25）**：BigGo 主力價錢批次 2/7 完成（731 個有效價）；PricesAPI 核心 29 驗收為選用後備；本地已重建 v1.2.6（深色模式對比度修正 + 代碼重構），線上 Pages 待 push 後同步
...
| 淘汰黑名單 | 1,103（2026-08-18 首輪全量確認；自動停止更新，保留 EMSD/Price 舊版） |
